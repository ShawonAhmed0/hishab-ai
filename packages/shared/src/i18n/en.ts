...
export const en: Dictionary = {
  ...
  dashboard: {
    ...
    oneMonthOnly: "A trend needs at least two months of entries",
    dateRange: "Period",
    periodFrom: "From",
    periodTo: "To",
    applyRange: "Show",
  ...
  activity: {
    ...
    hint: "Who is regular, who has gone quiet, and whose dues are ageing",
    status: {
      normal: "Normal",
      doubtful: "Doubtful",
      critical: "Critical",
    ...
    dailyTitle: "Today's alerts",
    dailyHint: (date: string) => `As of ${date}`,
    likelyLost: "Likely lost",
    likelyLostBody: (names: string) => `No order in a long while — ${names}`,
    enteredDoubtful: "Turned doubtful today",
    enteredCritical: "Turned critical today",
    agedToday: "Crossed an ageing threshold today",
    agedTodayBody: (name: string, days: string) => `${name} — ${days} days overdue`,
    volumeDrops: "Buying less",
    volumeDropBody: (name: string, now: string, before: string) =>
      `${name} — ${now} now, against ${before} before`,
    volumeDropBadge: "Buying less",
    followUps: "Follow-up calls",
    followUpLine: (name: string) => `Give ${name} a follow-up call`,
    followUpHint: "Anyone yellow or red stays on the list until they order again",
    noAlerts: "Nothing new today",
    allHealthy: "Every customer is ordering as usual",
    reactivation: "Win-back list",
    reactivationHint: "They used to order regularly, and then stopped",
    noReactivation: "Nobody who ordered regularly has stopped",
    statusColumn: "Status",
    lastOrder: "Last order",
    neverOrdered: "Never ordered",
    daysSilent: (days: string) => `Quiet for ${days} days`,
    orderCount: "Orders",
    orderCountValue: (count: string) => `${count} times`,
    recentVolume: "Recent buying",
    baselineVolume: "Their usual",
    overdueDays: (days: string) => `${days} days overdue`,
    call: "Call",
    noPhone: "No phone number",
    onlyReactivation: "Win-back list only",
  ...
  entry: {
    ...
    addCost: "Add a cost",
    costKind: "Cost type",
    costName: "What it was",
    costNamePlaceholder: "e.g. crane hire",
    costAmount: "Amount",
    removeCost: (n: string) => `Remove cost ${n}`,
    costsHint:
      "Transport and labour go into the cost of the goods; the rest are expensed to their own \u0996\u09be\u09a4",
    costsHintSale: "Every cost here is added to the customer's bill",
    costCapitalised: "Goes into the cost of the goods",
  ...
  settings: {
    ...
    activityHint: "How long a customer has to stay quiet before it is worth a call",
    doubtfulDays: "Doubtful after (days)",
    doubtfulDaysHint: "No order for this many days turns them yellow",
    criticalDays: "Critical after (days)",
    criticalDaysHint: "No order for this many days turns them red",
    recentDays: "Recent window (days)",
    recentDaysHint: "Buying inside this window counts as \"now\"",
    baselineDays: "Comparison window (days)",
    baselineDaysHint: "Their own average is taken over this many days",
    volumeDropPercent: "Volume drop (%)",
    volumeDropHint: "A fall of this much against their own average is doubtful. 0 turns it off",
  ...
  auth: {
    ...
    newPasswordSubtitle: "This link only works once",
    newPassword: "New password",
    confirmPassword: "Type it again",
    savePassword: "Save password",
    passwordsDoNotMatch: "The two passwords do not match.",
    resetLinkExpired: "That link has expired. Please ask for another.",
    resetFailed: "The password could not be changed. Please try again.",
    signUpFailed: "The account could not be created. Please try again.",
    linkProblem: "That link did not work. Please ask for another.",
  ...
  masterData: {
    ...
    assignedTo: "Looked after by",
    assignedToHint: "This person is told when the customer goes quiet",
